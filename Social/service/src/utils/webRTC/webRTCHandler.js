...
export const callToOtherUser = (calleeDetails, userId) => {
  
  connectedUserSocketId = calleeDetails;
  store.dispatch(setCallState(callStates.CALL_IN_PROGRESS));
  store.dispatch(setCallingDialogVisible(true));
  wss.sendPreOffer({
    callee: connectedUserSocketId,
    caller: userId
...
export const rejectIncomingCallRequest = (connectedUserSocketId) => {
  wss.sendPreOfferAnswer({
    callerSocketId: connectedUserSocketId,
...
export const checkIfCallIsPossible = () => {
  ...
  store.getState().callStates.CALL_AVAILABLE) {
    return false;
  } else {
    return true;
  }
